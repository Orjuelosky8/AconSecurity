...
export default function Header({ onAssistantClick }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-background/60 backdrop-blur-md shadow-lg transition-all border-b border-border/40">
      <div className="container flex h-[74px] max-w-screen-2xl items-center px-4 md:px-8">
        {/* Logo con animación */}
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button
            ...
            className="rounded-full shadow-md bg-gradient-to-r from-primary via-indigo-600 to-sky-500 text-primary-foreground font-semibold px-6 py-2 hover:scale-105 transition-transform hidden md:flex"
            style={{
              boxShadow:
