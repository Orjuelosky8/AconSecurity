              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="flex flex-col items-center text-center">
                    <div className="flex items-center justify-center w-16 h-16 rounded-full bg-accent text-accent-foreground mb-4 shadow-md">
                      <span className="text-2xl font-bold">1</span>
                    </div>
                    <h3 className="font-semibold mb-2">Busco solución para</h3>
                    <ModernDarkSelect field={field} options={stepOptions.solutionType} />
                    {errors.solutionType && (
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="flex flex-col items-center text-center">
                    ...
                    <ModernDarkSelect field={field} options={stepOptions.entityType} />
                    {errors.entityType && (
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="flex flex-col items-center text-center">
                    ...
                    <ModernDarkSelect field={field} options={stepOptions.situation} />
                    {errors.situation && (
